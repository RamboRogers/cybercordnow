...
Environment overrides:
  ...
  CYBERCORD_IMAGE        Server image (default: ghcr.io/ramborogers/cybercord-server:0.1.2)
USAGE
}
...
CYBERCORD_IMAGE="${CYBERCORD_IMAGE:-ghcr.io/ramborogers/cybercord-server:0.1.2}"
